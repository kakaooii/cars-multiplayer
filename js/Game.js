class Game {
  ...
  showRank() {
    swal({
      title: `meu deus!${"\n"}Classificação${"\n"}${player.rank}`,
      text: "Você chegou a linha de chegada com sucesso, você é bom",
      imageUrl:
        "https://raw.githubusercontent.com/vishalgaddam873/p5-multiplayer-car-race-game/master/assets/cup.png",
      imageSize: "100x100",
      confirmButtonText: "-->aee,vou jogar de novo<--"
    });
  }

  gameOver() {
    swal({
      title: `acabou pra você`,
      text: "eita meu deus, você falhou na corrida mais facil",
      imageUrl:
        "https://cdn.shopify.com/s/files/1/1061/1924/products/Thumbs_Down_Sign_Emoji_Icon_ios10_grande.png",
      imageSize: "100x100",
      confirmButtonText: "-->jogar denovo<--"
    });
  ...
  //Método end
    ...
    swal({
      title: `Eita você explodiu! `,
      text: " será que fez kaboom? ",
      imageUrl:
        "https://www.pngmart.com/files/15/Comic-Explosion-Bubble-PNG-HD.png",
      imageSize: "200x200",
      confirmButtonText: "-->comece denovo,não exploda de novo<--  "
    })
  }
